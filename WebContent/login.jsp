...
<BODY  bgColor=#ffffff leftMargin=0 background="<c:url value='/picture/bj1.gif'/>" topMargin=0>
		<form name="loginForm" action="${pageContext.request.contextPath }/userAction_login" method="post" style="margin-top:250px;">
			<DIV align=center>
											...
											<TD align="right" background="" height=13>
												<DIV align=left>
													<FONT color=#006633 size=2>用户名：</FONT><FONT color=#006633
														...
														size=15 name="name"> </FONT><FONT color=#006633 size=2>
													</FONT>
												</DIV></TD>
											<TD rowSpan=4>
											...
											<TD align="left" height=21>
												<DIV align=center>
													<FONT color=#006633 size=2> <input class=txt1
														style="BACKGROUND-COLOR: #ffffff" type="submit" value="确定"> <INPUT class=txt1
														style="BACKGROUND-COLOR: #ffffff" type=reset value="取消"> </FONT>
												</DIV>
											</TD>
										</TR>
										<TR>
