  ...
  <script type="text/javascript">
       function isDelete(id){
    	   // 确认删除 ..  传统 
    	    ...
    	    if(flag){
    	    	location.href="${pageContext.request.contextPath}/storeAction_delete?id="+id;
    	    }
       };
       function isUpdate(id){
    	  ...
    	  if(flag){
    		  location.href="${pageContext.request.contextPath}/storeAction_findStore?id="+id;
    	  }
       }
								...
								<table class="store">
									...
									<s:iterator var="s" value="stores">
										...
										<td>
											...
											<a href="javascript:void(0);" onclick="isUpdate('<s:property value="id"/>');">修改</a>
											<a href="javascript:void(0);" onclick="isDelete('<s:property value="id"/>');">删除</a>
										</td>		
									</tr>
